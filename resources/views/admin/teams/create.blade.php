...
@section('content')
    <div class="flex flex-row justify-between my-4">
        <p class="text-xl font-semibold">Add New Member</p>
        <a class="button" href="{{ route('team.index') }}">Back</a>
    </div>
    <form action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data" id="submitForm" class="form">
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input type="integer" id="position" name="position" class="form-input" value="{{ old('position') }}">
            @error('position')
                <script>
        ...
        <div class="mb-6">
            ...
            <textarea rows="3" id="statement" name="statement" class="form-input">{{ old('statement') }}</textarea>
            @error('statement')
                <script>
